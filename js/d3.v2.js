(function() {
    ...
    function L(e, t) {
        ...
        arguments.length < 1 ? (e = 1,
        n = t / 4) : n = t / (2 * Math.PI) * Math.asin(1 / e),
        function(r) {
    ...
    function X(e, t, n) {
        ...
        return (a = ds.get(e)) ? t(a.r, a.g, a.b) : (e != null && e.charAt(0) === "#" && (e.length === 4 ? (r = e.charAt(1),
        r += r,
        i = e.charAt(2),
        i += i,
        s = e.charAt(3),
        s += s) : e.length === 7 && (r = e.substring(1, 3),
        i = e.substring(3, 5),
        s = e.substring(5, 7)),
        r = parseInt(r, 16),
        i = parseInt(i, 16),
    ...
    function vt(e) {
        ...
        return function(n, r) {
            ...
            r ? (t.lastIndex = 0,
            t.test(o) || (o = h(o + " " + e),
            s ? i.baseVal = o : n.className = o)) : o && (o = h(o.replace(t, " ")),
    ...
    function Tt(e, t, n) {
        ...
        e.tween = function(t, n) {
            return arguments.length < 2 ? i.get(t) : (n == null ? i.remove(t) : i.set(t, n),
            e)
        }
        ,
        e.ease = function(t) {
            return arguments.length ? (o = typeof t == "function" ? t : d3.ease.apply(d3, arguments),
            e) : o
        }
        ,
        e.each = function(t, n) {
            return arguments.length < 2 ? Nt.call(e, t) : (s.on(t, n),
            e)
        }
        ,
        d3.timer(function(r) {
            return St(e, function(e, u, a) {
                function f(r) {
                    return v.active > t ? c() : (v.active = t,
    ...
    function Lt() {
        ...
        while (n)
            ...
            n = n.next;
        var r = At() - t;
        r > 24 ? (isFinite(r) && (clearTimeout(Ws),
        Ws = setTimeout(Lt, r)),
        zs = 0) : (zs = 1,
        Xs(Lt))
    }
    function At() {
        var e = null
          ...
          , n = Infinity;
        while (t)
            t.flush ? (delete Rs[t.callback.id],
            t = e ? e.next = t.next : Us = t.next) : (n = Math.min(n, t.then + t.delay),
            t = (e = t).next);
        return n
    }
    function Ot(e, t) {
    ...
    function Wt(e, t) {
        ...
        ,
        n.domain = function(i) {
            return arguments.length ? (t = i[0] < 0 ? Vt : Xt,
            r = t.pow,
            e.domain(i.map(t)),
            n) : e.domain().map(r)
        }
        ...
        n.tickFormat = function(e, i) {
            ...
            if (arguments.length < 1)
                return i;
            var s = Math.max(.1, e / n.ticks().length), o = t === Vt ? (u = -1e-12,
            Math.floor) : (u = 1e-12,
            Math.ceil), u;
            return function(e) {
    ...
    function $t(e, t) {
        ...
        ,
        n.domain = function(t) {
            return arguments.length ? (e.domain(t.map(r)),
            n) : e.domain().map(i)
        }
        ,
        n.ticks = function(e) {
    ...
    function sn(e) {
        function t(t) {
            ...
            while (++c < h)
                i.call(this, p = t[c], c) ? l.push([+d.call(this, p, c), +v.call(this, p, c)]) : l.length && (o(),
                l = []);
            return l.length && o(),
        ...
        t.interpolate = function(e) {
            return arguments.length ? (typeof e == "function" ? a = s = e : a = (s = eo.get(e) || an).key,
            t) : a
        }
        ,
    ...
    function pn(e, t) {
        return e.length < 3 ? an(e) : e[0] + vn((e.push(e[0]),
        e), mn([e[e.length - 2]].concat(e, [e[1]]), t))
    }
    function dn(e, t, n) {
    ...
    function Nn(e) {
        ...
        while (++u < a)
            n = xn(e[u], e[u + 1]),
            Math.abs(n) < 1e-6 ? o[u] = o[u + 1] = 0 : (r = o[u] / n,
            i = o[u + 1] / n,
            s = r * r + i * i,
    ...
    function Ln(e) {
        function t(t) {
            ...
            : u(s), x, T;
            while (++m < g)
                a.call(this, y = t[m], m) ? (d.push([x = +b.call(this, y, m), T = +w.call(this, y, m)]),
                v.push([+E.call(this, y, m), +S.call(this, y, m)])) : d.length && (o(),
                d = [],
                v = []);
            return d.length && o(),
        ...
        ,
        t.interpolate = function(e) {
            return arguments.length ? (typeof e == "function" ? l = f = e : l = (f = eo.get(e) || an).key,
            c = f.reverse || f,
            h = f.closed ? "M" : "L",
            t) : l
        }
            ...
            if (p > 2) {
                ...
                for (l = 3; l < p; l++) {
                    ...
                    var d = 0
                      , v = 1
                      , m = 1;
                    for (c = a._pack_next; c !== a; c = c._pack_next,
                    v++)
                        if (yr(c, f)) {
                            d = 1;
                            break
                    ...
                    if (d == 1)
                        for (h = u._pack_prev; h !== c._pack_prev; h = h._pack_prev,
                        m++)
                            if (yr(h, f))
                                break;
                    d ? (v < m || v == m && a.r < u.r ? gr(u, a = c) : gr(u = h, a),
                    l--) : (mr(u, f),
                    a = f,
                    t(f))
                }
        ...
        n.parseRows = function(e, t) {
            function n() {
                ...
                if (e.charCodeAt(t) === 34) {
                    ...
                    return o === 13 ? (l = !0,
                    e.charCodeAt(n + 2) === 10 && s.lastIndex++) : o === 10 && (l = !0),
                    e.substring(t + 1, n).replace(/""/g, '"')
                }
                var a = s.exec(e);
                return a ? (l = a[0].charCodeAt(0) !== u,
                e.substring(t, a.index)) : (s.lastIndex = e.length,
                e.substring(t))
            }
            var r = {}, i = {}, o = [], a = 0, f, l;
            s.lastIndex = 0;
        ...
        var n = {
          ...
          , r = {
            ...
            leftBound: function(e) {
                ...
                do
                    t = t.r;
                while (t != r.rightEnd && i.rightOf(t, e));return t = t.l,
                t
            },
            del: function(e) {
                e.l.r = e.r,
            ...
            rightOf: function(e, t) {
                ...
                if (n.a === 1) {
                    var s = t.y - r.y
                      ...
                      , u = 0
                      , a = 0;
                    !i && n.b < 0 || i && n.b >= 0 ? a = u = s >= n.b * o : (a = t.x + t.y * n.b > n.c,
                    n.b < 0 && (a = !a),
                    a || (u = 1));
                    if (!u) {
    ...
    function yi(e, t, n) {
        ...
        return r ? (e.m = qo.get(r[0].toLowerCase()),
        n += r[0].length) : -1
    }
    function bi(e, t, n) {
        jo.lastIndex = 0;
        var r = jo.exec(t.substring(n));
        return r ? (e.m = Fo.get(r[0].toLowerCase()),
        n += r[0].length) : -1
    }
    function wi(e, t, n) {
        ...
        normal: function(e, t) {
            ...
            function() {
                ...
                do
                    ...
                    r = Math.random() * 2 - 1,
                    i = n * n + r * r;
                while (!i || i > 1);return e + t * n * Math.sqrt(-2 * Math.log(i) / i)
            }
        },
    ...
    d3.split = function(e, t) {
        ...
        while (++s < o)
            t.call(r, i = e[s], s) ? r = [] : (r.length || n.push(r),
            r.push(i));
        return n
    }
    ,
    ...
    d3.xhr = function(e, t, n) {
        ...
        t = null) : t && r.overrideMimeType && r.overrideMimeType(t),
        r.open("GET", e, !0),
    ...
    d3.interpolateString = function(e, t) {
        ...
        while (r < f)
            l = a.pop(),
            u[l.i + 1] == null ? u[l.i] = l.x : (u[l.i] = l.x + u[l.i + 1],
            u.splice(l.i + 1, 1)),
            f--;
    ...
    d3.interpolateTransform = function(e, t) {
        ...
        return u[0] != a[0] || u[1] != a[1] ? (n.push("translate(", null, ",", null, ")"),
        r.push({
            i: 1,
        ...
        f != l ? (f - l > 180 ? l += 360 : l - f > 180 && (f += 360),
        r.push({
        ...
        p[0] != d[0] || p[1] != d[1] ? (i = n.push(n.pop() + "scale(", null, ",", null, ")"),
        r.push({
            i: i - 4,
    ...
    ps.brighter = function(e) {
        ...
        var t = this.r
          ...
          , r = this.b
          , i = 30;
        return !t && !n && !r ? U(i, i, i) : (t && t < i && (t = i),
        n && n < i && (n = i),
        r && r < i && (r = i),
        U(Math.min(255, Math.floor(t / e)), Math.min(255, Math.floor(n / e)), Math.min(255, Math.floor(r / e))))
    }
    ,
    ...
    ks.select = function(e) {
        ...
        for (var o = -1, u = this.length; ++o < u; ) {
            ...
            for (var a = -1, f = i.length; ++a < f; )
                (s = i[a]) ? (n.push(r = e.call(s, s.__data__, a)),
    ...
    ks.selectAll = function(e) {
        ...
        for (var i = -1, s = this.length; ++i < s; )
            for (var o = this[i], u = -1, a = o.length; ++u < a; )
                if (r = o[u])
                    t.push(n = Ji(e.call(r, r.__data__, u))),
                    n.parentNode = r;
        return ft(t)
    }
    ,
    ...
    ks.data = function(e, t) {
        function n(e, n) {
            ...
            if (t) {
                ...
                for (i = -1; ++i < o; )
                    b = t.call(n, m = n[i], i),
                    g.has(b) ? (h[i] = v = g.get(b),
                    v.__data__ = m,
                    p[i] = d[i] = null) : (p[i] = yt(m),
                    h[i] = d[i] = null),
                    g.remove(b);
                for (i = -1; ++i < s; )
                    g.has(y[i]) && (d[i] = e[i])
    ...
    ,
    ks.call = function(e) {
        return e.apply(this, (arguments[0] = this,
        arguments)),
        this
    }
    ,
    ...
    As.select = function(e) {
        ...
        for (var u = -1, a = this.length; ++u < a; ) {
            ...
            for (var f = -1, l = s.length; ++f < l; )
                (o = s[f]) ? (n.push(i[f] = r = e.call(s.parentNode, o.__data__, f)),
    ...
    Os.select = function(e) {
        ...
        for (var s = -1, o = this.length; ++s < o; ) {
            ...
            for (var u = this[s], a = -1, f = u.length; ++a < f; )
                (i = u[a]) && (r = e.call(i.node, i.node.__data__, a)) ? ("__data__"in i.node && (r.__data__ = i.node.__data__),
                n.push({
                    node: r,
                    delay: i.delay,
                    duration: i.duration
    ...
    Os.attrTween = function(e, t) {
        function n(e, n) {
            ...
            return r === Is ? (this.removeAttribute(i),
            null) : r && function(e) {
        ...
        function r(e, n) {
            ...
            return r === Is ? (this.removeAttributeNS(i.space, i.local),
            null) : r && function(e) {
    ...
    Os.styleTween = function(e, t, n) {
        ...
        this.tween("style." + e, function(r, i) {
            ...
            return s === Is ? (this.style.removeProperty(e),
            null) : s && function(t) {
    ...
    d3.tween = function(e, t) {
        ...
        return typeof e == "function" ? n : e == null ? Ct : (e += "",
        r)
    }
    ;
    ...
    d3.timer = function(e, t, n) {
        ...
        var r = Rs[e.id];
        r && r.callback === e ? (r.then = n,
        r.delay = t) : Rs[e.id = ++qs] = Us = {
            callback: e,
            then: n,
            delay: t,
            next: Us
        },
        zs || (Ws = clearTimeout(Ws),
        zs = 1,
        Xs(Lt))
    }
    ,
    ...
    d3.svg.arc = function() {
        ...
        return e.innerRadius = function(n) {
            return arguments.length ? (t = u(n),
            e) : t
        }
        ,
        e.outerRadius = function(t) {
            return arguments.length ? (n = u(t),
            e) : n
        }
        ,
        e.startAngle = function(t) {
            return arguments.length ? (r = u(t),
            e) : r
        }
        ,
        e.endAngle = function(t) {
            return arguments.length ? (i = u(t),
            e) : i
        }
        ,
        e.centroid = function() {
    ...
    d3.svg.chord = function() {
        ...
        return e.radius = function(t) {
            return arguments.length ? (a = u(t),
            e) : a
        }
        ,
        e.source = function(t) {
            return arguments.length ? (s = u(t),
            e) : s
        }
        ,
        e.target = function(t) {
        ...
        ,
        e.startAngle = function(t) {
            return arguments.length ? (f = u(t),
            e) : f
        }
        ,
        e.endAngle = function(t) {
            return arguments.length ? (l = u(t),
            e) : l
        }
        ,
        e
    ...
    d3.svg.brush = function() {
        ...
        function i() {
            ...
            function c() {
                d3.event.keyCode == 32 && S == 2 && (T[0] += f[1][0],
                T[1] += f[1][1],
                S = 0,
                M())
            }
            function h() {
                ...
                N && (e[0] += N[0],
                e[1] += N[1]),
                S || (d3.event.altKey ? (x || (x = [(f[0][0] + f[1][0]) / 2, (f[0][1] + f[1][1]) / 2]),
                T[0] = f[+(e[0] < x[0])][0],
                T[1] = f[+(e[1] < x[1])][1]) : x = null),
                w && p(e, o, 0) && (n(y),
                s = !0),
                E && p(e, u, 1) && (r(y),
                s = !0),
            ...
            function p(e, t, n) {
                ...
                S ? c = (a += o) + u : (x && (o = Math.max(i, Math.min(s, 2 * x[n] - a))),
                o < a ? (c = a,
                a = o) : c = o);
                if (f[0][n] !== a || f[1][n] !== c)
                    return l = null,
        ...
        e.extent = function(t) {
            var n, r, i, s, a;
            return arguments.length ? (l = [[0, 0], [0, 0]],
            o && (n = t[0],
            r = t[1],
            u && (n = n[0],
            r = r[0]),
            ...
            l || (i = f[0][1],
            s = f[1][1],
            u.invert && (i = u.invert(i),
            s = u.invert(s)),
            s < i && (a = i,
            i = s,
            s = a))),
            o && u ? [[n, i], [r, s]] : o ? [n, r] : u && [i, s])
        }
        ,
        e.clear = function() {
            return l = null,
    ...
    d3.behavior.drag = function() {
        ...
        function t() {
            ...
            r ? (l = r.apply(o, arguments),
            l = [l.x - c[0], l.y - c[1]]) : l = [0, 0],
            f || M(),
            u({
                type: "dragstart"
            })
    ...
    d3.behavior.zoom = function() {
        ...
        return e.translate = function(t) {
            return arguments.length ? (h = t.map(Number),
            e) : h
        }
        ,
        e.scale = function(t) {
        ...
        e.scaleExtent = function(t) {
            return arguments.length ? (m = t == null ? lo : t.map(Number),
            e) : m
        }
        ,
        e.x = function(t) {
    ...
    d3.layout.chord = function() {
        ...
        return n.matrix = function(e) {
            return arguments.length ? (o = (s = e) && s.length,
            r = i = null,
            n) : s
        }
        ,
    ...
    d3.layout.force = function() {
        ...
        n.linkDistance = function(e) {
            return arguments.length ? (l = u(e),
            n) : l
        }
        ,
        n.distance = n.linkDistance,
        n.linkStrength = function(e) {
            return arguments.length ? (c = u(e),
            n) : c
        }
        ,
        ...
        ,
        n.charge = function(e) {
            return arguments.length ? (h = typeof e == "function" ? e : +e,
            n) : h
        }
        ,
    ...
    d3.layout.stack = function() {
        ...
        ,
        e.order = function(t) {
            return arguments.length ? (n = typeof t == "function" ? t : ho.get(t) || nr,
            e) : n
        }
        ,
        e.offset = function(t) {
            return arguments.length ? (r = typeof t == "function" ? t : po.get(t) || rr,
            e) : r
        }
        ,
        e.x = function(t) {
      ...
      , po = d3.map({
        ...
        wiggle: function(e) {
            ...
            for (o = 1; o < r; ++o) {
                ...
                for (s = 0,
                f = 0,
                c = n[o][0] - n[o - 1][0]; s < t; ++s) {
                    for (u = 0,
                    l = (e[s][o][1] - e[s][o - 1][1]) / (2 * c); u < s; ++u)
    ...
    d3.layout.histogram = function() {
        function e(e, s) {
            ...
            if (h > 0) {
                ...
                while (++s < c)
                    d = u[s],
                    d >= a[0] && d <= a[1] && (l = o[d3.bisect(f, d, 1, h) - 1],
                    l.y += p,
                    l.push(e[s]))
            }
            return o
            ...
            function u(e, t, r) {
                if (t) {
                    ...
                    o && i)
                        ...
                        c += u._tree.mod,
                        f += s._tree.mod;
                    o && !Or(s) && (s._tree.thread = o,
                    s._tree.mod += l - f),
                    i && !Ar(u) && (u._tree.thread = i,
                    u._tree.mod += a - c,
                    r = e)
                }
                return r
    ...
    d3.layout.treemap = function() {
        ...
        function n(t) {
            ...
            if (r && r.length) {
                ...
                while (u = o.pop())
                    a.push(u),
                    a.area += u.area,
                    u.z != null && (i(a, u.z ? s.dx : s.dy, s, !o.length),
                    a.length = a.area = 0);
                r.forEach(n)
            }
        }
        ...
        s.padding = function(e) {
            ...
            if (!arguments.length)
                return f;
            var r;
            return l = (f = e) == null ? Ir : (r = typeof e) === "function" ? t : r === "number" ? (e = [e, e, e, e],
            n) : n,
            s
        }
        ,
        s.round = function(e) {
            return arguments.length ? (u = e ? Math.round : Number,
            s) : u != Number
        }
        ,
        s.sticky = function(e) {
    ...
    d3.geo.azimuthal = function() {
        function e(e) {
            var n = e[0] * mo - s, o = e[1] * mo, f = Math.cos(n), l = Math.sin(n), c = Math.cos(o), h = Math.sin(o), p = t !== "orthographic" ? a * h + u * c * f : null, d, v = t === "stereographic" ? 1 / (1 + p) : t === "gnomonic" ? 1 / p : t === "equidistant" ? (d = Math.acos(p),
            d ? d / Math.sin(d) : 0) : t === "equalarea" ? Math.sqrt(2 / (1 + p)) : 1, m = v * c * l, g = v * (a * c * f - u * h);
        ...
        e.translate = function(t) {
            return arguments.length ? (i = [+t[0], +t[1]],
            e) : i
        }
        ,
        e.origin([0, 0])
    ...
    d3.geo.albers = function() {
        ...
        ,
        e.origin = function(e) {
            return arguments.length ? (n = [+e[0], +e[1]],
            t()) : n
        }
        ,
        e.parallels = function(e) {
            return arguments.length ? (r = [+e[0], +e[1]],
            t()) : r
        }
        ,
        e.scale = function(t) {
        ...
        ,
        e.translate = function(t) {
            return arguments.length ? (s = [+t[0], +t[1]],
            e) : s
        }
        ,
        t()
    ...
    d3.geo.albersUsa = function() {
        ...
        return e.scale = function(s) {
            return arguments.length ? (t.scale(s),
            n.scale(s * .6),
            r.scale(s),
            i.scale(s * 1.5),
            e.translate(t.translate())) : t.scale()
        }
        ,
    ...
    d3.geo.bonne = function() {
        ...
        e.parallel = function(t) {
            return arguments.length ? (o = 1 / Math.tan(s = t * mo),
            e) : s / mo
        }
        ,
        e.origin = function(t) {
            return arguments.length ? (r = t[0] * mo,
            i = t[1] * mo,
            e) : [r / mo, i / mo]
        }
        ,
        ...
        ,
        e.translate = function(t) {
            return arguments.length ? (n = [+t[0], +t[1]],
            e) : n
        }
        ,
    ...
    d3.geo.path = function() {
        ...
        e.pointRadius = function(t) {
            return typeof t == "function" ? s = t : (s = +t,
            o = zr(s)),
            e
        }
        ,
    ...
    d3.geo.circle = function() {
        ...
        function n(e) {
            ...
            while (++t < n)
                c = a.distance(f = e[t]),
                c < u ? (o && i.push(ni(o, f)((l - u) / (l - c))),
                i.push(f),
                s = o = null) : (o = f,
                !s && i.length && (i.push(ni(i[i.length - 1], o)((u - l) / (c - l))),
                s = o)),
                l = c;
            return s = e[0],
            o = i[0],
        ...
        var f = Ur({
            ...
            LineString: function(e) {
                ...
                return t.length && (e = Object.create(e),
                e.coordinates = t,
                e)
            },
            MultiLineString: function(e) {
            ...
            Polygon: function(e) {
                ...
                return t[0].length && (e = Object.create(e),
                e.coordinates = t,
                e)
            },
            MultiPolygon: function(e) {
        ...
        ,
        e.angle = function(t) {
            return arguments.length ? (u = (o = +t) * mo,
            e) : o
        }
        ,
    ...
    d3.geo.greatArc = function() {
        ...
        e.precision = function(t) {
            return arguments.length ? (s = t * mo,
            e) : s / mo
        }
        ,
        e
    ...
    d3.geom.hull = function(e) {
        ...
        for (s = 1; s < n; ++s)
            o = r[s].index,
            d == r[s].angle ? (a = e[p][0] - e[u][0],
            f = e[p][1] - e[u][1],
            l = e[o][0] - e[u][0],
            c = e[o][1] - e[u][1],
            a * a + f * f >= l * l + c * c ? r[s].index = -1 : (r[h].index = -1,
            d = r[s].angle,
            h = s,
            p = o)) : (d = r[s].angle,
            h = s,
    ...
    d3.geom.polygon = function(e) {
        ...
        e.clip = function(t) {
            ...
            while (++r < i) {
                ...
                while (++s < o)
                    l = n[s],
                    si(l, u, a) ? (si(f, u, a) || t.push(oi(f, l, u, a)),
                    t.push(l)) : si(f, u, a) && t.push(oi(f, l, u, a)),
                    f = l;
                u = a
            }
            return t
    ...
    d3.geom.voronoi = function(e) {
        ...
        return ui(e, function(e) {
            var n, r, i, s, o, u;
            e.a === 1 && e.b >= 0 ? (n = e.ep.r,
            r = e.ep.l) : (n = e.ep.l,
            r = e.ep.r),
            e.a === 1 ? (o = n ? n.y : -1e6,
            i = e.c - e.b * o,
            u = r ? r.y : 1e6,
            s = e.c - e.b * u) : (i = n ? n.x : -1e6,
            o = e.c - e.a * i,
            s = r ? r.x : 1e6,
            u = e.c - e.a * s);
            var a = [i, o]
    ...
    d3.geom.quadtree = function(e, t, n, r, i) {
        function s(e, t, n, r, i, s) {
            ...
            if (e.leaf) {
                var u = e.point;
                u ? Math.abs(u.x - t.x) + Math.abs(u.y - t.y) < .01 ? o(e, t, n, r, i, s) : (e.point = null,
                o(e, u, n, r, i, s),
                o(e, t, n, r, i, s)) : e.point = t
            } else
                o(e, t, n, r, i, s)
        }
    ...
    d3.time.format = function(e) {
        function t(t) {
            var r = [], i = -1, s = 0, o, u;
            while (++i < n)
                e.charCodeAt(i) == 37 && (r.push(e.substring(s, i), (u = Ro[o = e.charAt(++i)]) ? u(t) : o),
                s = i + 1);
